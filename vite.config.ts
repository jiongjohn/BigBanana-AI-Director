...
import { createInferenceProxyHandler } from './server/inferenceProxyCore.mjs';
...
const createDevInferenceProxyPlugin = (): Plugin => ({
  name: 'dev-inference-proxy',
  configureServer(server) {
...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      plugins: [react(), createDevMediaProxyPlugin(), createDevNewApiProxyPlugin(), createDevInferenceProxyPlugin()],
      define: {
